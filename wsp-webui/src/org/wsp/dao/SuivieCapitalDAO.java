...
public class SuivieCapitalDAO {
	...
	public List<SuivieCapital> getSoldeSession(TradingSession tradingSession) {
	...
	@SuppressWarnings("unchecked")
	public List<SuivieCapital> getSoldeSession(TradingSession tradingSession, Date date) {
		return sessionFactory
				.getCurrentSession()
				.createQuery(
